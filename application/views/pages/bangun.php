<?php
  ...
  <h3>'.$row->bangun.'</h3>
    ...
    <li><a href="'.base_url().'pembangunan"><i class="fa fa-building-o"></i> Pembangunan</a></li>
    <li class="active"><i class="fa fa-building-o"> '.$row->bangun.'</i></li>
  </ol>
  <hr>
        <small class="post-date" >Posted on: '.$row->tanggal.'</small><br>
    <img src="'.base_url().'assets/images/pembangunan/'.$row->image.'"><br>
...
<div class="row">
  <div class="col-md-10">
  <?php echo form_open('comment/pembangunan', 'class="form-horizontal"'); ?>
          <input type="hidden" name="id_pembangunan" value="<?php foreach ($bangun as $row) { echo $row->id; } ?>">
