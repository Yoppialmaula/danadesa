<h1>Tambahkan Pembangunan</h1>
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>admin/pembangunan"><i class="fa fa-building-o"> Pembangunan</i></a></li>
      <li class="active"><i class="fa fa-pencil"> Input Pembangunan</i></li>
    </ol>
    <hr>
    <a class="btn btn-default" href="<?php echo base_url(); ?>admin/pembangunan"><i class="fa fa-arrow-circle-left"> Back</i></a>
    <br>
    <div class="row">
    <?php echo form_open_multipart('input/pembangunan', 'class="form-horizontal"' ); ?>
      <div class="col-sm-5">
      ...
      <div class="col-sm-6">
            ...
            <div class="form-group">
              <label>Bangun</label>
                <input type="text" name="bangun" class="form-control" placeholder="Acara" required="required">
            </div>
            <div class="form-group">
              <label>Lokasi</label>
